...
<div class="form-group">
    <label class="col-md-2 control-label">意向产品</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'pid',  CHtml::listData(ProductExt::model()->normal()->findAll(),'id','name'), array('class'=>'form-control select2','empty'=>'无')); ?>
    </div>
