...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'cid', CHtml::listData(TagExt::model()->findAll("cate='hczl'"),'id','name'), array('class' => 'form-control', 'encode' => false)); ?>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'fid', CHtml::listData(TagExt::model()->findAll("cate='hcpp'"),'id','name'), array('class' => 'form-control', 'encode' => false)); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'fid') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">材质</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'mid', CHtml::listData(TagExt::model()->findAll("cate='hccz'"),'id','name'), array('class' => 'form-control', 'encode' => false)); ?>
    </div>
