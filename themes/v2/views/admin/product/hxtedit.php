...
<div class="form-group">
    <label class="col-md-2 control-label">原料</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'cid', CHtml::listData(TagExt::model()->findAll("cate='hxtyl'"),'id','name'), array('class' => 'form-control', 'encode' => false)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'fid', CHtml::listData(TagExt::model()->findAll("cate='hxtgn'"),'id','name'), array('class' => 'form-control', 'encode' => false)); ?>
    </div>
